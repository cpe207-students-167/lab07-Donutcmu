...
submitBtn.onclick = () => {
  ...
  if(PassInput.value===ConPassInput.value&&ConPassInput.value.length>=6){
  ...
  if (isFirstNameOk&&isLastNameOk&&isEmailOk&&isPassword&&isCon) alert("Registered successfully");
